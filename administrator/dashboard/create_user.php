        ...
        <div class="row">
		  ...
		  <section class="col-lg-8">
            ...
            <div class="card card-danger">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="actions/create_user_actions.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputName">Name</label>
                    <input required type="text" class="form-control" name="user_name" id="exampleInputName" placeholder="Enter name">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputSurname">Surname</label>
                    <input required type="text" class="form-control" name="user_surname" id="exampleInputSurname" placeholder="Enter surname">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Password</label>
                    <input required type="password" class="form-control" name="user_password" id="exampleInputPassword1" placeholder="Password">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input required type="email" class="form-control" name="user_email" id="exampleInputEmail1" placeholder="Enter email">
                  </div>
				  ...
				  <div class="input-group">
                    ...
                    <input required type="text" name="user_phone" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                  </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                  <button type="submit" name="create_user_btn" class="btn btn-danger savebtn">Save Changes</button>
                </div>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select name="user_status" class="form-control">
                      <option selected name="simple">Simple User</option>
				  ...
				  <div class="form-group">
                    ...
                    <select name="active_status" class="form-control">
                      <option selected name="active">Active</option>
