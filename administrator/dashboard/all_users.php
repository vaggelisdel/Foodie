<?php
	...
	if ($_SESSION['admin_authorised'] == 0){
		...
		$result_all_users = mysqli_query($connect, $query);
	}
?>
<!DOCTYPE html>
<html>
               ...
               <table id="example1" class="table table-bordered table-striped">
				...
				?>
							<tr>
							  ...
							  ?>
							  <td><center><a href="edit_user.php?&userid=<?= $row["UserID"] ?>"><button type="button" class="btn btn-block btn-outline-primary btn-sm">Edit</button></a></center></td>
							</tr>
				<?php
						}
				?>
